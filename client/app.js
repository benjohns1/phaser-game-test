...
var remote_player = function (id, startx, starty, start_angle) {
	...
	// set a fill and line style
	this.player.beginFill(0x0099ff);
...
function onEnemyMove (data) {
	...
	var distance = physics.distanceToPointer(movePlayer.player, newPointer);
	speed = distance/0.05;
	
	movePlayer.rotation = physics.movetoPointer(movePlayer.player, speed, newPointer);
}
...
function onInputRecieved (data) {
	...
	var distance = physics.distanceToPointer(player, newPointer);
	...
	player.rotation = physics.movetoPointer(player, speed, newPointer);
